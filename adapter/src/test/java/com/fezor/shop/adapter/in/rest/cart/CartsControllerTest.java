...
import com.fezor.shop.application.port.in.cart.ProductNotFoundException;
...
import static com.fezor.shop.adapter.in.rest.HttpTestCommons.assertThatResponseIsError;
import static com.fezor.shop.adapter.in.rest.cart.CartsControllerAssertions.assertThatResponseIsCart;
...
class CartsControllerTest {
    ...
    void givenNotEnoughItemsInStock_addLineItem_returnsAnError()
        ...
        when(addToCartUseCase.addToCart(customerId, productId, quantity))
                .thenThrow(new NotEnoughItemsInStockException("Not enought items in stock", 2));
